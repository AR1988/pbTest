...
public class EmailControllerTest extends BasicAPITest implements IControllerTest {
    ...
    public void test001_add_200() throws IOException {
        ...
        EmailJson entityToAdd = ConstantsMockEntity.EMAIL_JSON;
    ...
    public void test002_getList_200() throws IOException {
        getRequest = new HttpGet(ENDPOINT_EMAIL + "/" + contactId + "/all");
        ...
        emailsListSize = jsonArray.length();
        JSONObject lastElementInList = jsonArray.getJSONObject(emailsListSize - 1);
        emailId = lastElementInList.getInt("id");

        LOGGER.info("Result:"
                + "\nContact id is: " + contactId
                + "\nEmail id is: " + emailId
                + "\nList size: " + emailsListSize
    ...
    public void test003_getById_200() throws IOException {
        getRequest = new HttpGet(ENDPOINT_EMAIL + "/" + emailId);
        getRequest.setHeader(ConstantsHeaders.HEADER_CONTENT_TYPE);
        getRequest.setHeader(authHeader);
        ...
        //assertEquals(EMAIL_JSON.getContactId(), jsonObj.getInt("id"));
        assertEquals(ConstantsMockEntity.EMAIL_JSON.getEmail(), jsonObj.getString("email"));
    }
    ...
    public void test004_editItem_200() throws IOException {
        ...
        EmailJson jsonToEditEntity = ConstantsMockEntity.EMAIL_EDIT_JSON;
        jsonToEditEntity.setContactId(contactId);
        jsonToEditEntity.setEmailId(emailId);
    ...
    public void test005_getChangedItemById_200() throws IOException {
        ...
        //TODO if ids added enable this
        //assertEquals(EMAIL_JSON.getContactId(), jsonObj.getInt("id"));
        assertEquals(ConstantsMockEntity.EMAIL_EDIT_JSON.getEmail(), jsonObj.getString("email"));
    }

    @Override
    @Test
    public void test006_removeById_200() throws IOException {
        deleteRequest = new HttpDelete(ENDPOINT_EMAIL + "/" + emailId);
    ...
    public void test007_statusBeforeAndAfterTests() throws IOException {
        ...
        LOGGER.info("Result:"
                + "\nList size after tests_001_add: " + emailsListSize
                + "\nList size after all tests: " + contactsSizeAfterTests);

        assertEquals(emailsListSize - 1, contactsSizeAfterTests);
    }
}
