...
import static com.apiTest.helpers.constans.ConstantsUrls.ENDPOINT_ADDRESS;
...
public class AddressControllerTest extends BasicAPITest implements IControllerTest {
    ...
    public void test001_add_200() throws IOException {
        ...
        AddressJson entityToAdd = ConstantsMockEntity.ADDRESS_JSON;
    ...
    public void test003_getById_200() throws IOException {
        ...
        assertEquals(ConstantsMockEntity.ADDRESS_JSON.getCity(), jsonResponseObj.getString("city"));
        assertEquals(ConstantsMockEntity.ADDRESS_JSON.getCountry(), jsonResponseObj.getString("country"));
        assertEquals(ConstantsMockEntity.ADDRESS_JSON.getStreet(), jsonResponseObj.getString("street"));
        assertEquals(ConstantsMockEntity.ADDRESS_JSON.getZip(), jsonResponseObj.getString("zip"));
    }
    ...
    public void test004_editItem_200() throws IOException {
        ...
        AddressJson jsonToEditEntity = ConstantsMockEntity.ADDRESS_EDIT_JSON;
    ...
    public void test005_getChangedItemById_200() throws IOException {
        ...
        assertEquals(ConstantsMockEntity.ADDRESS_EDIT_JSON.getCity(), jsonObj.getString("city"));
        assertEquals(ConstantsMockEntity.ADDRESS_EDIT_JSON.getCountry(), jsonObj.getString("country"));
        assertEquals(ConstantsMockEntity.ADDRESS_EDIT_JSON.getStreet(), jsonObj.getString("street"));
        assertEquals(ConstantsMockEntity.ADDRESS_EDIT_JSON.getZip(), jsonObj.getString("zip"));
    }
